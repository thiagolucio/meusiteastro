      ...
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-16 md:pt-16 lg:pt-20 text-center">
        ...
        >
          <div className="text-customGrayText text-sm lg:text-base xl:text-lg sm:text-base mt-10 px-12 sm:px-48 text-justify">
                 Utilizando tecnologias baseadas em Front-end Stacks como HTML, CSS, JavaScript, TypeScript.
                 Trabalhando em projetos em aplicações Web e Mobile.
                 Implementando conceitos de Design de Interação na construção intuitiva de interfaces com
