...
const projectsData = [
  {
    ...
    content:
      "Atuo no projeto Sem Parar como Desenvolvedor Front-end na equipe de Design System que cria componentes em React Native para as equipes de App e com StencilJS para as equipes de projetos Web (Angular, React, Next, etc.) criando a biblioteca de componentes desses projetos.",
    image: semParar,
  ...
  },
  {
    ...
    content:
      "Atuei no projeto como Desenvolvedor Front-end durante todo o ciclo de desenvolvimento. Lidar com Front-end e Back-end. Utilizando Angular no front-end, em conjunto com PrismaJs, NestJS e PostgreSQL em ambiente Azure Cloud. O projeto entrega uma Aplicação (WebAPP) que permite a gestão de espaços de trabalho/pessoais.",
    image: mySeat,
  ...
  },
  {
    ...
    content:
      "Filial da Rede Globo de Televisão em Santa Catarina trabalhando na NSC Comunicações como Desenvolvedor Front-end UX/UI. Tive a oportunidade de trabalhar em projetos como G1 de Santa Catarina, NSC Total, e outros, lidando com Design UX/UI, Front-end mas também com Back-end e DevOps.",
    image: nscTotal,
