      ...
      <div className="pt-10  lg:pt-20 lg:pb-12 bg-customDarkBg1 radius-for-skewed ">
        <div className="container mx-auto px-4 w-4/5 md:w-11/12 lg:w-10/12 xl:w-4/5 2xl:w-2/3">
          <div className="flex flex-wrap">
            <div className="w-full lg:w-1/3 mb-16 lg:mb-0">
              ...
              <p className="mb-10 mt-4 sm:w-[22rem] lg:w-[20rem] xl:w-[24rem] text-gray-400 leading-loose text-center lg:text-left mx-auto lg:mx-0">
                Veja mais sobre meu trabalho acessando as redes profissionais abaixo.
              </p>
                ...
                <ul>
                  <li className="mb-4 w-full flex justify-end content-end float-righ">
                    <a
                      ...
                      aria-label="Behance"
                    >
                      No meu perfil do Behance você poderá ver alguns trabalhos antigos como Sites e sistemas antigos feitos por mim.
          ...
          <p className="lg:text-center text-sm text-gray-400 border-t border-[rgb(255,255,255,0.2)] pt-12 mt-16 hidden lg:block">
            &copy; 2023. Esse site foi criado por mim mesmo usando AstroJS, TailwindCSS, Framer Motion e Font Source.
          </p>
        </div>
      </div>
    </footer>
